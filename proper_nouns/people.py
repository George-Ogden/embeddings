...
if __name__ == "__main__":
    run(
        input="Messi played for [MASK] in the world cup."
    )
    run(
        input="Ronaldo played for [MASK] in the world cup."
    )
    run(
        input="Obama was the president of [MASK]."
    )
    run(
    ...
    run(
        "Beyonce is well-known for her [MASK].",
        equation="her := + his - her / 2"
    )
    run(
        "Bolt was an Olympic [MASK] and some say he was the greatest of all time."
    )
    run(
        "Phelps was an Olympic [MASK] and some say he was the greatest of all time."
    )
    run(
        "Putin is president of [MASK].",
        equation="Putin := - Russia + India"
    )
    run(
        "Putin is president of [MASK].",
        equation="Putin := - Russia + England"
    )
    run(
